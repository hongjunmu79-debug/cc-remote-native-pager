...
**Current release: v3.0.0** · Distribution `3.0.0-pager.16` · Wire protocol v19
...
```bash
release=https://github.com/hongjunmu79-debug/cc-remote-native-pager/releases/download/v3.0.0-pager.16
