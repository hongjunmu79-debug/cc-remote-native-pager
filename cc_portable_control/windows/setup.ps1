...
.DESCRIPTION
    ...
    The archive layout is:
        ...
        setup.ps1
        cc_portable_control/windows/*     (install.ps1, config-first-run.ps1, ...)
...
$installer = Join-Path $scriptRoot "cc_portable_control\windows\install.ps1"
...
if (-not $InstallRoot) {
    ...
    # (cc_portable_control\windows\install.ps1) is located relative to $scriptRoot and is
